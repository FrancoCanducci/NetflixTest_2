...
# Teste adicional: verificar redirecionamento para login ao tentar acessar o perfil sem estar logado
...
if "login" in driver.current_url:
    print("Teste de segurança de redirecionamento para login: Sucesso.")
else:
    print("Teste de segurança de redirecionamento para login: Falhou.")
